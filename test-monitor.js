...
test('format NIFTYYYMMDDCNNNNN',  () => /^NIFTY\d{6}C\d+$/.test(buildSymbol(INSTRUMENTS.NIFTY, 23850, 'CE')));
...
test('format BSXYYMMDDCNNNNN',    () => /^BSX\d{6}C\d+$/.test(buildSymbol(INSTRUMENTS.SENSEX, 75500, 'CE')));
