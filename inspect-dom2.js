...
async function main() {
  ...
  await run('ChartApiInstance keys', `
    (function() {
  ...
  await run('_exposed_chartWidgetCollection', `
    (function() {
  ...
  await run('Pine editor (CodeMirror 6)', `
    (function() {
